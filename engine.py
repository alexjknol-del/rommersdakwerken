...
CSS = """
:root{
  --ink:#17191a;--ink-2:#3b4042;--muted:#6a7073;
  --line:#e2e4e3;--line-2:#d0d4d3;
  --bg:#fafaf9;--bg-2:#f1f2f1;
  --accent:#1f5d4c;--accent-2:#17483a;--deep:#23292c;
...
@media (prefers-color-scheme: dark){
  :root{--ink:#e8eaea;--ink-2:#c0c6c6;--muted:#8d9495;
    --line:#2b2f30;--line-2:#383d3e;
    --bg:#121415;--bg-2:#1a1d1e;
    --accent:#63b39b;--accent-2:#84c9b3;--deep:#ccd3d5;}
